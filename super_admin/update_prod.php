...
<head>
    ...
    <title>Super Admin | Tech Haven</title>
...
.in-stock {
    background-color: rgba(0, 151, 151, 0.15) !important;
    color: #006D6D !important;
    font-weight:bold;
}

.low-stock {
    background-color: rgba(255, 156, 7, 0.15) !important;
    color: #DB7600 !important;
font-weight:bold;
}

.out-of-stock {
    background-color: rgba(242, 0, 0, 0.15) !important;
