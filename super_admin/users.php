    ...
    <div class="dashboard-content">
        ...
        <h1>Customers</h1>
            <div class="heading-buttons">
                ...
                <a href="admins.php" class="button-link"><i class="bi bi-person-lock"></i> Admin Accounts</a>
...
<br>
       ...
       <table id="example" class="display" style="width:100%">
            ...
            <tbody>
                ...
                $sql = "SELECT customerID, name, email, contactNum, address FROM customerInfo";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>";
                        echo "<a href='#' onclick='openEditWindow(" . $row["customerID"] . ")' class='bi bi-pencil-square' title='Edit' style='color:#008686;font-size:18px;'></a>";
